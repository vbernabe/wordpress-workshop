...
function siteorigin_panels_lite_admin_menu(){
	add_theme_page(
		__('Custom Home Page Builder', 'siteorigin-north'),
		__('Home Page', 'siteorigin-north'),
		'edit_theme_options',
		'so_panels_home_page',
...
function siteorigin_panels_lite_render_admin_home_page(){
	add_meta_box( 'so-panels-panels', __( 'Page Builder', 'siteorigin-north' ), 'siteorigin_panels_metabox_render', 'appearance_page_so_panels_home_page', 'advanced', 'high' );
	...
	if( ( $prefix == 'post.php' || $prefix == 'post-new.php' ) ) {
		...
		if( current_user_can( 'install_plugins' ) ) {
			...
			wp_localize_script( 'siteorigin-panels-lite-teaser', 'panelsLiteTeaser', array(
				'tab'        => __( 'Page Builder', 'siteorigin-north' ),
				'buttons'    => array(
					'install'   => __('Install', 'siteorigin-north'),
					'cancel'    => __('Cancel', 'siteorigin-north'),
				),
				'message'    => __( "Refresh this page after you've installed Page Builder.", 'siteorigin-north' ),
	...
	if( current_user_can('edit_theme_options') ) {
		...
		<p class="siteorigin-panels-lite-message">
			<?php if( current_user_can( 'install_plugins' ) ) : ?>
				<?php
				printf(
					__('<a href="%s">Install Page Builder</a> to <a href="%s">edit</a> this default home page.', 'siteorigin-north'),
					$install_url,
					admin_url('themes.php?page=so_panels_home_page')
				); ?>
			<?php endif; ?>

			<?php printf( __("<a href='%s'>Disable this page</a> if you'd prefer to have a standard blog home.", 'siteorigin-north'), $toggle_url ) ?>
		</p>
		<?php
	}
